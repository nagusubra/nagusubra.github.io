...
Subu's personal site -- built with [Astro](https://astro.build) +
Tailwind CSS. Static output, no client-side framework, ships almost no
JavaScript. Deployed to GitHub Pages via GitHub Actions.
...
You already have this code locally (or downloaded it). To publish:
