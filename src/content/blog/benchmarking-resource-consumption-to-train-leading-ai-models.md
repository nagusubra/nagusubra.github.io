---
title: "Benchmarking Resource Consumption to Train Leading AI Models"
description: "Training a leading-edge AI model draws on power, water, carbon, and land. I benchmarked the resource consumption of top LLMs using public data and estimates."
publishDate: 2025-01-01
tags: ["ai","llm","energy","sustainability","economics"]
kind: "essay"
draft: false
---
...
![](/posts/benchmarking-resource-consumption-to-train-leading-ai-models/img-01.png)
...
![](/posts/benchmarking-resource-consumption-to-train-leading-ai-models/img-02.png)

![](/posts/benchmarking-resource-consumption-to-train-leading-ai-models/img-03.png)

Source: [https://github.com/nagusubra/model\_training\_resource\_consumption\_benchmark](https://github.com/nagusubra/model_training_resource_consumption_benchmark)

![](/posts/benchmarking-resource-consumption-to-train-leading-ai-models/img-04.png)

![](/posts/benchmarking-resource-consumption-to-train-leading-ai-models/img-05.png)

Source: [https://github.com/nagusubra/model\_training\_resource\_consumption\_benchmark](https://github.com/nagusubra/model_training_resource_consumption_benchmark)

The race to train the most powerful AI models has often come with a hefty price tag — both in terms of computational resources and environmental impact. But amidst the giants of Meta’s LLaMA 3.1 and OpenAI’s GPT-4, there’s a shining example of efficiency: [DeepSeek V3](https://arxiv.org/pdf/2412.19437). **This model stands out not only for its performance but for how economically it was trained**, proving that smarter and power-efficient models are possible in the future of AI development.
